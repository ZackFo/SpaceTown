...
class Game:
    ...
    #Alien stuff
        ...
        #music and sounds
        #music = pygame.mixer.Sound('sound goes here')
        ...
        for row_index, row in enumerate(self.shape):
            for col_index, col in enumerate(row):
                if col == "x": 
                    ...
                    block = obstacle.Block(self.block_size,(241,200,0),x,y)
    ...
    def alien_setup(self, rows, cols, x_distance = 60, y_distance = 48, x_offset = 70, y_offset = 100):
        for row_index, row in enumerate(range(rows)):
            for col_index, col in enumerate(range(cols)):
                ...
                if row_index == 0: alien_sprite = Alien("Lsp",x,y)
                elif 1 <= row_index <= 2: alien_sprite = Alien("Ricardio",x,y)
                else: alien_sprite = Alien("Gunter",x,y)
